...
<AccordionGroup>
  <Accordion title="Transferência Concluída" icon="check-circle">
...
<CardGroup cols={2}>
  <Card title="PAID_OUT" icon="check-circle" color="#4CAF50">
    Transferência concluída com sucesso
  </Card>
  <Card title="ERROR" icon="xmark-circle" color="#F44336">
